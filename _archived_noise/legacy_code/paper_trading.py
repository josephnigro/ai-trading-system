...
# PAPER TRADING MODE
# ==============================
# Simulate trades without real money for backtesting

class PaperTradingAccount:
    """
    Simulates trades and accounts without real money
    Used for testing and validation before live trading
    """
    
    def __init__(self, starting_balance=25000, use_real_prices=True):
